...
<div id="<?php echo $carouselId;?>" class="<?php echo "carousel_{$name}";?> carousel slide">
  ...
  ?>
    <div class="item <?php echo $active;?>">
      <?php if($overlayLink !== "") echo '<a href="'.$overlayLink.'">'?>
      ...
      <div class="container">
        <div class="carousel-caption">
          ...
          <?php if(strlen(trim($overlayButtonText)) > 0) echo "<p><a class=\"{$overlayButtonClass}\" href=\"{$overlayButtonLink}\">{$overlayButtonText}</a></p>";?>
        </div>
      </div>
    </div>
  <?php 
