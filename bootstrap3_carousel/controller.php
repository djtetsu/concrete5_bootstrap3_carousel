...
class Bootstrap3CarouselBlockController extends BlockController {

  protected $btName = "Bootstrap3Carousel";
  protected $btDescription = "Bootstrap 3 Carousel";
  
  protected $btTable = "btBootstrap3Carousel";
  protected $btTableImg = "btBootstrap3CarouselImg";
  ...
  protected $btExportTables = array("btBootstrap3Carousel", "btBootstrap3CarouselImg");
